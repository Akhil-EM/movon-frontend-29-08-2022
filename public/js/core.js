...
ashade.cursor = {
  ...
  animate: function () {
    ...
    ashade.cursor.currentX +=
      (ashade.cursor.targetX - ashade.cursor.currentX) * ashade.cursor.easing;
...
ashade.progress = {
      ...
      $bar_svg = jQuery(
        '\
          ...
          '" version="1.1" xmlns="http://www.w3.org/2000/svg">\
					 <circle class="ashade-progress-circle--bg" r="' +
          this_size.r +
          '" cx="' +
          this_size.barSize +
          '" cy="' +
          ...
          '" stroke-dashoffset="0"></circle>\
					 <circle class="ashade-progress-circle--bar" transform="rotate(-90, ' +
          this_size.barSize +
          ", " +
          this_size.barSize +
          ')" r="' +
  ...
  getSize: function (this_el) {
    ...
    sizes.dashOffset = parseFloat(
      sizes.dashArray - (sizes.dashArray * sizes.percent) / 100
    ).toFixed(2);
...
ashade.init = function () {
  ...
  if (jQuery("form.ashade-contact-form").length) {
    jQuery("form.ashade-contact-form").each(function () {
      ...
      $this.find("input")[0].addEventListener(
        "touchenter",
        function (e) {
          ashade.flocker.field_interract = true;
      ...
      $this.find("textarea")[0].addEventListener(
        "touchenter",
        function (e) {
          ashade.flocker.field_interract = true;
          ashade.flocker.form_interract = true;
      ...
      $this.submit(function (e) {
        ...
        if (
          ...
          ashade.flocker.field_interract &&
          ashade.flocker.field_changed
        ) {
  ...
  if (jQuery(".ashade-page-title-wrap").length) {
    if (jQuery(".ashade-content-wrap .ashade-content").length) {
      let ashade_mobile_title = jQuery(
        '<div class="ashade-mobile-title-wrap">' +
  ...
  if ($ashade_body.hasClass("ashade-maintenance-wrap")) {
    ashade_mobile_header.prepend(
      '<a class="ashade-contacts-toggler" href="#"><i class="la la-envelope"></i></a>'
    );
  ...
  if (jQuery(".ashade-lightbox-link").length) {
    ...
    jQuery(document).on("click", ".ashade-lightbox-link", function (e) {
      ...
      ashade.pswp.lightbox = new PhotoSwipe(
        $ashade_body.find(".pswp")[0],
...
ashade.layout = function () {
  ...
  if (jQuery("#ashade-home-contacts").length) {
    jQuery("#ashade-home-contacts").css(
      "padding-top",
      $ashade_header.height() + "px"
    );
  }
...
ashade.change_location = function (this_href) {
  ...
  if ($ashade_body.hasClass("ashade-home-template")) {
    if (
      !$ashade_body.hasClass("ashade-home-state--contacts") &&
      !$ashade_body.hasClass("ashade-home-state--works")
    ) {
      var links_delay = 0.5,
        links_timeout = 0;
    } else {
    ...
    setTimeout(
      "jQuery('.ashade-home-link--works:not(.is-inactive)').removeClass('is-loaded')",
      links_timeout
    );
    gsap.to(".ashade-home-link--works:not(.is-inactive)", 0.5, {
      css: {
    ...
    setTimeout(
      "jQuery('.ashade-home-link--contacts:not(.is-inactive)').removeClass('is-loaded')",
      links_timeout
    );
    gsap.to(".ashade-home-link--contacts:not(.is-inactive)", 0.5, {
      css: {
